...
function Prices() {
    ...
    async function saveMessage(data) {
        try {
            ...
            openSnackBarFun(false, "Mensagem enviada! Em breve entraremos em contato.");
            reset();
        } catch(e) {
            console.log(e);
            openSnackBarFun();
    ...
    function auxBorder() {
        switch(packageUser) {
            case 'bronze': return "border-l-yellow-500 border-t-yellow-500 border-b-[#cd7f32] border-r-[#cd7f32] shadow-[#cd7f32]"
            case 'gold': return "border-l-yellow-300 border-t-yellow-300 border-b-yellow-400 border-r-yellow-400 shadow-yellow-400"
            case 'platinum' : return "border-l-gray-400 border-t-gray-400 border-b-gray-500 border-r-gray-500 shadow-gray-500"
            case 'custom' : return "border-l-green-400 border-t-green-400 border-b-green-500 border-r-green-500 shadow-green-400"
        }
    }
                    ...
                    <div className="flex flex-wrap w-full">
                        {
                            plans.map((plan, index) => (
                                <div key={index} className="relative bg-white max-w-xs mx-auto mb-12 border-[1px] border-[#bcc4ca] rounded-lg">
                                    <div  className="pt-12 pr-7 pb-9 pl-7">
                                        ...
                                        <ul className="flex-1 ml-1 mb-7 space-y-2 text-left">
                                            ...
                                            <li className="flex items-center cursor-pointer">
                                                <TaskAltIcon className="text-green-400" />
                                                <div className="ml-1">{plan.benefits.employee} Funcionários</div>
                                                <Tooltip
                                                    placement="top"
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>  handleSelectPlan(plan.packageNameParam)}
                                        >
                                            ESCOLHER
                                        </Button>
                                    </div>
                        ...
                        <div className="relative bg-white max-w-xs mx-auto mb-12 border-[1px] border-[#bcc4ca] rounded-lg">
                            <div  className="pt-12 pr-7 pb-9 pl-7">
                                ...
                                <ul className="flex-1 ml-1 mb-7 space-y-2 text-left">
                                    ...
                                    <li className="flex items-center cursor-pointer">
                                        <TaskAltIcon className="text-green-400" />
                                        <div className="ml-1">~ Funcionários</div>
                                        <Tooltip
                                            placement="top"
                                            title="Quantidade de funcionários que poderão fazer login simultaneamente"
                                        >
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap justify-center">
                        <div className="w-full lg:w-6/12 px-4">
                            <div className={`relative flex flex-col min-w-0 break-words w-full mb-6 border-4 rounded-lg ${auxBorder()} shadow-2xl rounded-lg`}>
                                <form className={`flex-auto p-5 lg:p-10 `} onSubmit={handleSubmit(saveMessage)}>
                                    <h4 className="text-center text-2xl font-semibold">
                                        Escolha um pacote e informe seus dados. Entraremos em contato o mais breve possível.
                                    </h4>
                                    <div className="relative w-full mb-3 mt-8">
                                        ...
                                        <input
                                            ...
                                            { ...register("name", {
                                                ...
                                                minLength: {
                                                    value: 5,
                                                    message: "Deve ter mais de 4 letras"
                                                }
                                            })}
                                        />
                                        <span className="text-red-500 pt-2">{errors.name && errors.name.message}</span>
                                    </div>
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        />
                                        <span className="text-red-500 pt-2">{errors.email && errors.email.message}</span>
                                    </div>
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        />
                                        <span className="text-red-500 pt-2">{errors.message && errors.message.message}</span>
                                    </div>
