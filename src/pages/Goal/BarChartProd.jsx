...
function BarChartProd({ budget }) {

    const totalOrcada = budget.totalOrcada;
    const totalProd =  budget.totalProd;
    const percent = ((totalProd / totalOrcada) * 100).toFixed(2);
        ...
        <Card className="border-[1px] border-gray-400 rounded-lg h-full">
            ...
            <Row className="justify-content-center">
                ...
                <div className="text-center">
                    <h5 className="mb-0 font-size-20">{maskPointThree(totalOrcada)}</h5>
                    <p className="text-muted">QUANTIDADE ORÇADA</p>
                </div>
                </Col>
                <Col sm={4}>
                <div className="text-center">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-muted">QUANTIDADE PRODUZIDA</p>
                </div>
                </Col>
            </Row>
            <ReactApexChart
...
BarChartProd.propTypes = {
    budget: PropTypes.any
};

export default BarChartProd;
