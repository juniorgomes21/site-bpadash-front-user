...
function TimeLineProfessionals(props) {
    ...
    async function apiGetTimeLine() {
        try {
            const response = await api.get("/prof/timeline");
                            ...
                            <div>
                                ...
                                }
                                {
                                    timeLine.length == 0 ?
                                        <AlertCustom
                                            type="info"
                                            msg="Você não possui nenhum arquivo de Profissionais!"
                                        />
                                    :
...
TimeLineProfessionals.propTypes = {
  t: PropTypes.any,
  chartsData: PropTypes.any,
  onGetChartsData: PropTypes.func,
};

export default withTranslation()(TimeLineProfessionals);
