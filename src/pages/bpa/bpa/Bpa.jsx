            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    {loading ? (
                        ...
                        <AlertCustom
                            msg={`Nenhum BPA encontrado no período ${formatMonth(
                                month
                            )} de ${year}`}
                            type="info"
                        />
                        ...
                        Array.from({ length: 1 }).map((_, index) => (
                            <div key={index}>
                                <div className="container-fluid mb-6">
                                    <Breadcrumbs
                                        title={props.t("BPA")}
                                        breadcrumbItem={props.t("BPA")}
                                    />
                                    <TitleBpa
                                        identifier={identifier}
                                        setBpa={setBpa}
                                        setLoadingBpa={setLoading}
                                    />
                                </div>
                                <div className="container-fluid mb-6">
                                    <Breadcrumbs
                                        title="Tables"
                                        breadcrumbItem="Tabela BPA-C"
                                    />
