...
function FilesConf(props) {
    ...
    async function getFiles() {
        try {
            ...
            if (item.dateCurrent.length > 0) {
                ...
                const newArray = item.datesFull.find(
                    (itemx) => itemx[1][0] == item.dateCurrent[0][1]
                );
    ...
    function handleChangeYear(event) {
        ...
        const newArray = fileConfigs[indexState].datesFull.find(
            (item) => item[1][0] == year
        );
                            ...
                            <div className="flex flex-wrap justify-evenly w-full my-12">
                                {files.map((file, index) => (
                                    ...
                                    >
                                        <div
                                            key={index}
                                            className={`flex flex-col items-center border-2 bg-white ${
                                                fileConfigs[index].datesFull
                                                    .length > 0
                                                    ? "border-green-500"
                                                    : "border-red-500"
                                            } ${
                                ...
                                <div className="w-4/5 border-[1px] border-default rounded-md">
                                    {datesYears.length == 0 ? (
                                        ...
                                        <>
                                            <div className="flex justify-center w-full my-8">
                                                <p className="text-base">
                                                    Selecione a forma com que o
                                                    sistema irá obter a data do
                                                    arquivo ({nameFile})
                                                </p>
                                            </div>
